...
public:
   ...
   Room()
    ...
    Room(int Illumination, int Freshness, string Name)
    {
        cout << "C-TOR WITH parameters!\n";
...
public:
    ...
    Cat(string Gender, string Color, int Happiness)
    {
        cout << "C-TOR WITH parameters!\n";
        SetGender(Gender);
        SetColor(Color);
...
public:
    ...
    Book(int Year, int Health, int Wearness, int Interestingness)
    {
        cout << "C-TOR WITH parameters!\n";
        SetYear(Year);
        SetHealth(Health);
...
int main()
{
    ...
    Room n(50, 100, "вітальня");
    n.Print();

    Cat c;
    c.Print();

    Cat m("кіт", "коричневий", 60);
    m.Print();
